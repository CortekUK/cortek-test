...
// --- Type Definitions ---
type IconType = 'shopify' | 'whatsapp' | 'meta' | 'chatgpt' | 'react' | 'tailwind';
...
const iconComponents: Record<IconType, { component: () => React.JSX.Element; color: string }> = {
  shopify: {
    component: () => (
      <svg viewBox="0 0 256 292" fill="currentColor" className="w-full h-full">
...
const skillsConfig: SkillConfig[] = [
  // Inner Orbit - Business Integrations
  { 
    id: 'shopify',
    orbitRadius: 100, 
    size: 55, 
...
const OrbitingSkill = memo(({ config, angle }: OrbitingSkillProps) => {
  ...
  return (
    ...
    >
      <div
        className="relative w-full h-full p-2 bg-gray-800/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg"
      >
...
export default function OrbitingSkills() {
  ...
  // Scale factor for mobile: reduce orbit sizes by 30%
  const scale = isMobile ? 0.7 : 1;

  const orbitConfigs: Array<{ radius: number; glowColor: GlowColor; delay: number }> = [
    { radius: 100 * scale, glowColor: 'cyan', delay: 0 },
    { radius: 180 * scale, glowColor: 'purple', delay: 1.5 }
  ];
